...
//Route::get('products/{product_id}/categories/{category_id}', [HomeController::class, 'ProductCategory'])->name
//('product-category'); // route('product-category', ['product_id' => 1, 'category_id' => 2])
